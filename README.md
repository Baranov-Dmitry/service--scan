...
Проект реализован на фреймворке React.js + typescript, для навигации использовался react-router-dom, для хранения состояния redux, для стилей styled-components + библиотека компонентов antd
